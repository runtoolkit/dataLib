#!/usr/bin/env python3
"""
DataLib Load Order & Basic Validation Script
"""
...
def main():
    ...
    print("🔍 DataLib Validation Starting...\n")
    ...
    version_set = root / "1_20_3/data/dl_load/functions/load/internal/version_set.mcfunction"
    if version_set.exists():
        content = version_set.read_text(encoding='utf-8')
        if "set #dl.major dl.pre_version 4" in content:
