...
$execute if data storage datalib:engine color.gradients.$(gradient) run function datalib:systems/color/internal/lerp_exec with storage datalib:engine _color_lerp_tmp
